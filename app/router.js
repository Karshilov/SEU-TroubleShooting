...
module.exports = app => {
  ...
  router.get('/wechatKey', controller.wechatKeyWordsReply.get);
  router.post('/wechatKey', controller.wechatKeyWordsReply.add);
  router.delete('/wechatKey', controller.wechatKeyWordsReply.delete);
