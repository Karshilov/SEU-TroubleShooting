...
module.exports = app => {
  ...
  router.get('/key', controller.wechatKey.list);
  router.post('/key/text', controller.wechatKey.addTextRely);
  router.post('/key/news', controller.wechatKey.addNewsRely);
  router.delete('/key', controller.wechatKey.delete);
